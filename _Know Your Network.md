...
Task:
 1. CoreTAAS must have the following SVIs
   ...
   - VLAN 10
     - IP address: 10.21.10.2
     - Description: WIFI-VLAN
     - Status: UP

   - VLAN 50
     - IP address: 10.21.50.2
     - Description: CCTV-VLAN
     - Status: UP

   - VLAN 100
     - IP address: 10.21.100.2
...
~~~
!@cmd
ping 10.21.1.2                 CoreTAAS
ping 10.21.1.4                 CoreBABA
ping 10.21.100.8               CUCM
ping 10.21.21.1            EDGE
~~~
